...
You can browse their website for other people's creations and paste them here.]],
	...
	DB_CREATE_ITEM_TEMPLATES_AURA_TT = [[An item template gives you buffs.
Uses your "At first glance" properties.]],
...
If your aura runs for a very long time (e.g. an egg, that hatches after 3 real time days), you might set the aura to "always active". This will cause to dormant time to be connsidered as run time.
	...
	EFFECT_AURA_APPLY_PREVIEW = "Apply aura |cff00ff00%1$s|r",
	EFFECT_AURA_APPLY_MERGE_MODE = "If already active",
	...
	AU_EXAMPLE_ACTION = "Empower yourself",
	...
	AU_FIELD_COLOR_TT = "Pick the color of the category and the border.\n\nUsually, only debuffs have a color.\n\n",
