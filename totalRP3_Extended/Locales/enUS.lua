...
-- INVENTORY
	...
	IT_CON_ERROR_TRADE = "Containers not set to only contain inner items cannot be traded or dropped while not empty.",
...
-- SEC
	...
	SEC_LEVEL_DETAILS_THIS = "Switch security for this object",
