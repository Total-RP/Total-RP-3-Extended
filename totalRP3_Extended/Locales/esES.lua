...
Cuando el aura expire, se activará el evento |cff00ff00Al expirar|r.]=],
	...
	["AU_FIELD_HELPFUL"] = "Beneficiosa",
	["AU_FIELD_HELPFUL_TT"] = [=[¿Tu aura es beneficiosa (beneficio) o perjudicial (perjuicio)?
 
Un aura beneficiosa suele ser algo que los jugadores quieren tener o conservar, mientras que un aura perjudicial es algo que no desean tener. Si le aplicas un perjuicio a un jugador, asegúrate de darle también una forma de librarse de él.]=],
...
|cff00ff00Aquí puedes usar etiquetas de variables.|r]=],
	...
	["AURA_FRAME_TITLE"] = "Auras de Total RP 3 Extended",
...
%s]=],
	...
	["DR_SEARCH_BUTTON"] = "Buscar |cff00ff00mis|r objetos",
	["DR_SEARCH_BUTTON_TT"] = "Buscar objetos tuyos en el área dentro de 15 yardas.",
...
|cffff9900¡Todos los objetos que están dentro se perderán!]=],
	...
	["DR_STASHES_SEARCH"] = "Buscar escondites de |cff00ff00jugadores|r",
	["DR_STASHES_SEARCH_ACTION"] = "Buscar escondites de otros jugadores en la zona dentro de un radio de 15 yardas.",
	["DR_STASHES_SEARCH_TT"] = "Se iniciará un escaneo durante 3 segundos. ¡No te muevas!",
	["DR_STASHES_SYNC"] = "Sincronizando...",
	["DR_STASHES_TOO_FAR"] = "Estás muy lejos de este escondite.",
	["DR_STASHES_WITHIN"] = "|cff00ff00Tus|r escondites en un radio de 15 yardas",
	["DR_SYSTEM"] = "Sistema de objetos en el suelo",
	["DR_SYSTEM_ACTION"] = "Abrir opciones de objetos en el suelo",
	["DR_SYSTEM_TT"] = [=[Suelta / busca objetos y crea / accede a tus escondites.
 
El sistema de objetos en el suelo no funciona en mazmorras/arenas/campos de batalla.]=],
	["EDITOR_BOTTOM"] = "Abajo",
	...
	["EDITOR_ID_COPY_POPUP"] = "Puedes copiar el ID del objeto de abajo si necesitas pegarlo en algún sitio.",
	["EDITOR_MAIN"] = "Principal",
	["EDITOR_MORE"] = "Más",
	["EDITOR_NOTES"] = "Notas libres",
	["EDITOR_PREVIEW"] = "Previsualizar",
	["EDITOR_SAVE_TT"] = "Guarda todos los cambios del objeto completo %s (objeto raíz y todos los objetos internos) e incrementa automáticamente el número de versión.",
	["EDITOR_TOP"] = "Arriba",
...
¿Guardar de todos modos?]=],
	["EDITOR_WIDTH"] = "Ancho",
	["EFFECT_AURA_APPLY"] = "Aplicar aura",
	["EFFECT_AURA_APPLY_DO_NOTHING"] = "no hacer nada",
	["EFFECT_AURA_APPLY_DO_NOTHING_TT"] = "Si el aura ya está aplicada sobre el jugador, ignora este efecto.",
	["EFFECT_AURA_APPLY_EXTEND"] = "prolongar duración",
	["EFFECT_AURA_APPLY_EXTEND_TT"] = "Si el aura ya está aplicada sobre el jugador, añade la duración por defecto del aura a su duración restante actual.",
	["EFFECT_AURA_APPLY_MERGE_MODE"] = "Si ya está aplicada",
	["EFFECT_AURA_APPLY_PREVIEW"] = "Aplicar aura |cff00ff00%1$s|r (%2$s: %3$s)",
	["EFFECT_AURA_APPLY_REFRESH"] = "reiniciar duración",
	["EFFECT_AURA_APPLY_REFRESH_TT"] = "Si el aura ya está aplicada sobre el jugador, establece su duración como si se hubiera aplicado de nuevo.",
	["EFFECT_AURA_APPLY_TT"] = [=[Aplica un aura sobre el jugador.
 
|cffff9900Si el aura ya está presente, sus variables no se sobrescribirán.]=],
	["EFFECT_AURA_DURATION"] = "Duración del aura",
	["EFFECT_AURA_DURATION_ADD"] = "añadir",
	["EFFECT_AURA_DURATION_ADD_TT"] = "Añade una cantidad de segundos a la duración.",
	["EFFECT_AURA_DURATION_PREVIEW"] = "Duración del aura |cff00ff00%1$s|r |cff00ff00%3$s|r |cffffff00%2$s segundos|r",
	["EFFECT_AURA_DURATION_SET"] = "establecer",
	["EFFECT_AURA_DURATION_SET_TT"] = "Establece la duración a una cantidad de segundos.",
	["EFFECT_AURA_DURATION_SUBTRACT"] = "restar",
	["EFFECT_AURA_DURATION_SUBTRACT_TT"] = "Resta una cantidad de segundos de la duración.",
	["EFFECT_AURA_DURATION_TT"] = "Cambia la duración de un aura.",
	["EFFECT_AURA_ID_TT"] = "Especifica el ID completo del aura.\\n\\nUtiliza el botón \"Explorar\" de abajo para buscar en tu base de datos.",
	["EFFECT_AURA_REMOVE"] = "Eliminar aura",
	["EFFECT_AURA_REMOVE_PREVIEW"] = "Eliminar aura |cff00ff00%1$s|r",
	["EFFECT_AURA_REMOVE_TT"] = [=[Elimina un aura del jugador.
 
|cffff9900Este efecto no activará los eventos Al expirar ni Al cancelar.]=],
	["EFFECT_AURA_RUN_WORKFLOW"] = "Ejecutar flujo de trabajo del aura",
	["EFFECT_AURA_RUN_WORKFLOW_PREVIEW"] = "Ejecutar flujo de trabajo |cff00ff00%2$s|r en el aura |cff00ff00%1$s|r",
	["EFFECT_AURA_RUN_WORKFLOW_TT"] = "Ejecuta el flujo de trabajo de un aura activa. El flujo de trabajo del aura tiene acceso a las variables de flujo de trabajo del flujo de trabajo actual.",
	["EFFECT_CAT_CAMERA"] = "Cámara",
	["EFFECT_CAT_CAMERA_LOAD"] = "Cargar cámara",
	["EFFECT_CAT_CAMERA_LOAD_TT"] = "Establece la posición de la cámara del jugador según una posición guardada previamente.",
	["EFFECT_CAT_CAMERA_SAVE"] = "Guardar cámara",
	["EFFECT_CAT_CAMERA_SAVE_TT"] = "Guarda la posición actual de la cámara del jugador en una de las 5 ranuras de guardado disponibles.",
	["EFFECT_CAT_CAMERA_SLOT"] = "Número de ranura",
	["EFFECT_CAT_CAMERA_SLOT_TT"] = "El índice de una de las ranuras disponibles, de 1 a 5.",
	["EFFECT_CAT_CAMERA_ZOOM_DISTANCE"] = "Distancia de zoom",
	["EFFECT_CAT_CAMERA_ZOOM_IN"] = "Acercar cámara",
	["EFFECT_CAT_CAMERA_ZOOM_IN_TT"] = "Acerca la cámara una distancia determinada.",
	["EFFECT_CAT_CAMERA_ZOOM_OUT"] = "Alejar cámara",
	["EFFECT_CAT_CAMERA_ZOOM_OUT_TT"] = "Aleja la cámara una distancia determinada.",
	["EFFECT_CAT_CAMPAIGN"] = "Campaña y misión",
	["EFFECT_CAT_SOUND"] = "Sonido y música",
	["EFFECT_CAT_SPEECH"] = "Diálogos y emociones",
	["EFFECT_COOLDOWN_DURATION"] = "Duración del tiempo de reutilización",
	["EFFECT_COOLDOWN_DURATION_TT"] = "La duración del tiempo de reutilización, en segundos.",
	["EFFECT_DIALOG_ID"] = "ID de escena",
	["EFFECT_DIALOG_QUICK"] = "Escena rápida",
	["EFFECT_DIALOG_QUICK_TT"] = "Genera una escena rápida con un único paso. Utilizará automáticamente el objetivo del jugador como interlocutor.",
	["EFFECT_DIALOG_START"] = "Iniciar escena",
	["EFFECT_DIALOG_START_PREVIEW"] = "Iniciar escena %s.",
	["EFFECT_DIALOG_START_TT"] = "Inicia una escena. Si ya se está reproduciendo una escena, será interrumpida y sustituida por esta.",
	["EFFECT_DISMOUNT"] = "Desmontar",
	["EFFECT_DISMOUNT_TT"] = "Desmonta al jugador de su montura actual.",
	["EFFECT_DISPET"] = "Retirar mascota de duelo",
	["EFFECT_DISPET_TT"] = "Retira a la mascota de duelo invocada actualmente.",
	["EFFECT_DO_EMOTE"] = "Realizar emoción",
	["EFFECT_DO_EMOTE_ANIMATED"] = "Animadas",
	["EFFECT_DO_EMOTE_OTHER"] = "Otros",
	["EFFECT_DO_EMOTE_SPOKEN"] = "Habladas",
	["EFFECT_DO_EMOTE_TT"] = "Hace que el jugador realice una emoción animada específica.",
	...
	["EFFECT_DOC_ID_TT"] = [=[El documento a mostrar.
 
|cffffff00Introduce el ID completo del documento (ID de los padres e ID interno).
 
|cff00ff00Consejo: copia/pega el ID completo para evitar errores tipográficos.]=],
	["EFFECT_ITEM_ADD"] = "Añadir objeto",
	["EFFECT_ITEM_ADD_CRAFTED"] = "Creado",
	["EFFECT_ITEM_ADD_ID"] = "ID de objeto",
	["EFFECT_ITEM_ADD_ID_TT"] = [=[El objeto a añadir.
 
|cffffff00Introduce el ID completo del objeto (ID de los padres e ID interno).
 
|cff00ff00Consejo: copia/pega el ID completo para evitar errores tipográficos.]=],
	["EFFECT_ITEM_ADD_PREVIEW"] = "Añadir %sx %s",
	["EFFECT_ITEM_ADD_QT"] = "Cantidad",
	["EFFECT_ITEM_ADD_QT_TT"] = [=[El número de objetos a añadir.
 
|cff00ff00Ten en cuenta que el addon hará lo posible por alcanzar esta cantidad, pero es posible que no se añadan todos los objetos: por ejemplo, si la bolsa se llena o si el objeto tiene un máximo de unidades que el personaje puede tener (atributo 'Único').]=],
