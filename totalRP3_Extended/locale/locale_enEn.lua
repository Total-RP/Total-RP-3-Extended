...
Warning: If the animation flickers it's because there is a problem with the animation for your classe. If it happens, please select another animation.]],
	...
	EFFECT_SOURCE_WORKFLOW_TT = "Search and store the variable in the workflow execution. The scope for this variable is limited to the workflow execution and will be discarded afterward.",
	EFFECT_SOURCE_OBJECT = "Object",
	EFFECT_SOURCE_OBJECT_TT = "Search and store the variable in the workflow source object.\n\nOnly works if the source object is an item or a campaign/quest/step.\n\nIn the case of a campaign, quest or quest step, the variable will be stored in the campaign level (global for the whole campaign).",
	EFFECT_SOURCE_CAMPAIGN = "Active campaign",
	EFFECT_SOURCE_CAMPAIGN_TT = "Search and store the variable in the current campaign, if there is a currently active campaign.",
