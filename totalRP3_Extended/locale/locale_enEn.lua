...
Warning: If the animation flickers it's because there is a problem with the animation for your classe. If it happens, please select another animation.]],
	...
	EFFECT_VAR_WORK = "Workflow variable operation",
	EFFECT_VAR_WORK_TT = "Performs an operation on a variable for the current workflow execution.\n\n|cff00ff00This variable exists only during a workflow execution and will be discarded afterward.\n\n|cffff9900For math operations: If the variable does not exists or can't be cast as a number, it will be initialized at 0.",
	EFFECT_VAR_OBJECT_CHANGE = "Object variable operation",
	EFFECT_VAR_OBJECT_CHANGE_TT = "Performs an operation on a object variable.\n\nThe variable will be searched and stored in the object executing this workflow (Items, campaigns, quests or quest steps).\n\n|cffff9900For math operations: If the variable does not exists or can't be cast as a number, it will be initialized at 0.",
